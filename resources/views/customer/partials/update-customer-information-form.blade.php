<section>
    ...
    <form method="post" action="{{ route('customer.update', $customer->id) }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-text-input id="phone" name="phone" type="tel" class="mt-1 block w-full" :value="old('phone', $customer->phone)" required autofocus autocomplete="phone" />
        ...
        <div>
            ...
            <x-text-input id="created_date" name="created_date" type="datetime-local" class="mt-1 block w-full" :value="old('created_date', $customer->created_date)" required/>
